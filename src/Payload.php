...
use Ns147\SodiumAuth\Exceptions\PayloadException;
...
class Payload implements ArrayAccess, Arrayable, Countable, Jsonable, JsonSerializable
{
     ...
     *
     * @var \Ns147\SodiumAuth\Claims\Collection
     */
    private $claims;
     ...
     * @param  \Ns147\SodiumAuth\Validators\PayloadValidator  $validator
     ...
     * @param  string  $claim
     *
     * @return \Ns147\SodiumAuth\Claims\Claim
     */
     ...
     * @param  mixed  $value
     *
     * @throws \Ns147\SodiumAuth\Exceptions\PayloadException
     */
    ...
    public function __call($method, $parameters)
    {
        if (preg_match('/get(.+)\b/i', $method, $matches)) {
            foreach ($this->claims as $claim) {
                if (get_class($claim) === 'Ns147\\SodiumAuth\\Claims\\'.$matches[1]) {
