...
{
    /**
     * @var \Mockery\MockInterface|\Ns147\SodiumAuth\Claims\Factory
     */
    ...
    public function it_should_return_a_payload_when_passing_an_array_of_claims()
    {
        ...
        $this->claimFactory->shouldReceive('make')->twice()->with('jti')->andReturn(new TokenId('foo'));
        ...
        $this->claimFactory->shouldReceive('get')->twice()->with('jti', 'foo')->andReturn(new TokenId('foo'));
